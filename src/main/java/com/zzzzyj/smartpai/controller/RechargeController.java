...
import com.zzzzyj.smartpai.service.RechargeService;
import com.zzzzyj.smartpai.service.WxPayService;
...
public class RechargeController {
    ...
    public ResponseEntity<?> getPackages() {
        try {
            List<com.zzzzyj.smartpai.model.RechargePackage> packages = rechargeService.getAllPackages();
