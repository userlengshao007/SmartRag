...
import com.zzzzyj.smartpai.model.RechargeOrder;
import com.zzzzyj.smartpai.model.RechargeOrder.OrderStatus;
import com.zzzzyj.smartpai.model.RechargePackage;
import com.zzzzyj.smartpai.repository.RechargeOrderRepository;
import com.zzzzyj.smartpai.repository.RechargePackageRepository;
import com.zzzzyj.smartpai.utils.PriceUtil;
...
public class RechargeService {
    ...
    public WxPayService.PrePayInfoResBo createRechargeOrder(
        ...
        if (packageId != null && packageId > 0) {
            ...
            description = "【SmartRag】充值套餐：" + rechargePackage.getPackageName();
        } else {
            // 自定义充值
            ...
            description = "【SmartRag】自定义充值￥" + PriceUtil.toYuanPrice(amount) + "元";
        }
