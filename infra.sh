...
MINIO_DIR="${MINIO_DIR:-${ROOT_DIR}/.runtime/minio}"
MINIO_API_PORT="9000"
MINIO_CONSOLE_PORT="9001"
MINIO_CMD="./minio server data/ --console-address :${MINIO_CONSOLE_PORT}"

KAFKA_DIR="${KAFKA_DIR:-${ROOT_DIR}/.runtime/kafka}"
KAFKA_PORT="9092"
KAFKA_CMD="./start-kafka.sh"

ELASTICSEARCH_DIR="${ELASTICSEARCH_DIR:-${ROOT_DIR}/.runtime/elasticsearch}"
